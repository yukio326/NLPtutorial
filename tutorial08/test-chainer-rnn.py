#python test-chainer-rnn.py ../../data/titles-en-test.word rnn_model xid.txt yid.txt my_answer_chainer.word 2
#../../script/grade-prediction.py ../../data/titles-en-test.labeled my_answer_chainer.word
