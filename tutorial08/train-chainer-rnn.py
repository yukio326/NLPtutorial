#python train-chainer-rnn.py ../../data/wiki-en-train.norm_pos rnn_model xid.txt yid.txt 50 20 0.01
...
class RecurrentNeuralNetwork(Chain):
    def __init__(self, input_size, hidden_size, output_size):
        super(RecurrentNeuralNetwork, self).__init__(
            link_xh = links.Linear(input_size, hidden_size),
            link_hh = links.Linear(hidden_size, hidden_size),
