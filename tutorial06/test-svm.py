#python test-svm.py ../../data/titles-en-test.word model.txt my_answer.word
...
def test_svm(fin_path, model_path, fout_path):
    with open(fout_path, "w") as fout:
        for y in PREDICT_ALL(model_path, fin_path):
            fout.write("{}\n".format(y))

if __name__ == "__main__":
    test_svm(sys.argv[1], sys.argv[2], sys.argv[3])
