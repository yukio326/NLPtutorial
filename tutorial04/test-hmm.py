#python test-hmm.py ../../data/wiki-en-test.norm model.txt my_answer.pos 0.95 1000000
...
def test_hmm(fin_path, model_path, fout_path, lambda_1, vocabulary):
...
if __name__ == "__main__":
    test_hmm(sys.argv[1], sys.argv[2], sys.argv[3], float(sys.argv[4]), int(sys.argv[5]))
